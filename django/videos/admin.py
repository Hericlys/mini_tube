...
from .form import VideoChunkFinishUploadForm, VideoChunkUploadForm
from .models import Video, Tag
from .services import VideoChunkUploadException, VideoMediaInvalidStatusException, VideoMediaNotExistsException, create_video_service_factory
...
class VideoAdmin(admin.ModelAdmin):
    ...
    def redirect_to_upload(self, obj: Video):
        url = reverse('admin:video_upload', args=[obj.id])
